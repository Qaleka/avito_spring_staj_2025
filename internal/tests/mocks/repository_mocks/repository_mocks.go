...
func (m *MockPvzRepository) CreateReception(ctx context.Context, data models.Reception) error {
	args := m.Called(ctx, data)
	return args.Error(0)
}

func (m *MockPvzRepository) GetPvzById(ctx context.Context, pvzId string) (*models.Pvz, error) {
	args := m.Called(ctx, pvzId)
	return args.Get(0).(*models.Pvz), args.Error(1)
}

func (m *MockPvzRepository) GetCurrentReception(ctx context.Context, pvzId string) (*models.Reception, error) {
	args := m.Called(ctx, pvzId)
	if args.Get(0) == nil {
...
func (m *MockPvzRepository) AddProductToReception(ctx context.Context, product models.Product) error {
	args := m.Called(ctx, product)
	return args.Error(0)
}

func (m *MockPvzRepository) GetLastProductInReception(ctx context.Context, receptionId string) (*models.Product, error) {
	args := m.Called(ctx, receptionId)
	return args.Get(0).(*models.Product), args.Error(1)
}

func (m *MockPvzRepository) DeleteProductById(ctx context.Context, productId string) error {
	args := m.Called(ctx, productId)
	return args.Error(0)
}

func (m *MockPvzRepository) CloseReception(ctx context.Context, reception *models.Reception) error {
